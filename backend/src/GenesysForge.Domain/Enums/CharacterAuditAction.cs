...
public enum CharacterAuditAction
{
    ...
    /// <summary>
    /// Позиция перенесена между персонажем и транспортом либо установлена на него
    /// (ROT-TRANSPORT-01). Записывается всегда: по этой строке видно, у кого вещь сейчас.
    /// </summary>
    CargoMoved,
}
