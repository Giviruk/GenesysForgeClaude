...
## 4. Heroic Abilities: пункты 1, 2, 5, 8 и 10
...
## 5. Бой, здоровье и Defense: пункты 1–6
...
RoT использует Core-механику без общего переопределения.
...
RoT добавляет контент, но не заменяет общий Core-порядок. Не каждая беседа является
«социальным боем».
