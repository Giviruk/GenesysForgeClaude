...
- [x] PR открыт.
- [x] Исправить падение CI e2e после переименования вкладки Game Table.

## Что осталось / блокеры

PR открыт: #77.
CI e2e smoke обновлён под новое имя вкладки «Игровой стол».
...
- После фикса e2e локально повторно прошли `npm run lint`, `npm run test`, `git diff --check`; full-stack `npm run test:e2e` не запущен локально, потому что Docker Desktop engine не был доступен.
