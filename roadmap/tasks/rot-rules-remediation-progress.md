...
- [ ] **ROT-HA-02**, **ROT-HA-05**, **ROT-HA-08**, **ROT-HA-10**, **ROT-HA-CONTENT**
...
- Следующий пункт по порядку — **ROT-HA-02** (параметры Paragon, Sixth Sense и Signature Weapon).
  Его часть про transient attachment зависит от движка attachments (раздел 8) — вероятно, придётся
  делать параметры Paragon/Sixth Sense сейчас, а Signature Weapon после ROT-EQP-ATT-02.
