...
## U-31 · Исправление прогрессии героических способностей RoT
- **Статус:** ✅ Done (PR #97)
- **Источник:** пользовательский запрос · исправление U-18
- **Зачем:** привести получение ability points и варианты улучшения Heroic Ability к правилам Realms of Terrinoth.
- **Scope (B/F):** убрать стартовое очко; начислять 1 очко за каждые 50 XP сверх стартового XP вида; добавить Power, Duration, Frequency, Story и до двух разных Secondary Effects с книжными стоимостями и ограничениями; запретить смену способности после завершения создания; показать структурные покупки на листе.
- **DoD:** новая механика валидируется backend; старый `HeroicUpgradeRank` остаётся совместимым представлением Power; UI поддерживает все виды улучшений; private-full содержит полные авторские парафразы механических описаний; миграция и документация обновлены.
