...
задач из [tasks/rot-rules-remediation-progress.md](tasks/rot-rules-remediation-progress.md)
**не искать заново**, а сразу брать готовый источник.

> ⚖️ Напоминание: в **public-safe** часть нельзя класть дословный текст книг.
...
### Добавлено по запросу §2 (2026-06-25) — закрывает все недостающие источники
...
## 2. Статус материалов — всё закрыто ✅ (2026-06-25)
...
## 3. Рекомендации по организации (на будущее)
